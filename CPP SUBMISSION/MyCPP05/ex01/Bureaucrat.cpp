...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/10 10:50:46 by tbertozz          #+#    #+#             */
/*   Updated: 2022/10/10 11:09:48 by tbertozz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat	&Bureaucrat::operator++( int ) 
{
	...
	{
		this->grade--;
        std::cout << this->name << "'s grade was increased by 1!" << std::endl;
	}
	return (*this);
}
...
Bureaucrat	&Bureaucrat::operator--( int ) 
{
	...
	{
		this->grade++;
        std::cout << this->name << "'s grade was decreased by 1!" << std::endl;
	}
	return (*this);
}
...
void		Bureaucrat::signForm( Form &form )
{
	...
	{
		form.setSigned(true);
		std::cout << this->name << " has successfully signed form " << form.getName() << "." << std::endl;
	}
}
